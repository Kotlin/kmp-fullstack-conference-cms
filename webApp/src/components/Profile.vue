...
import { fetchTalkInfo, updateTalkInfo, runValidations, talkValidation } from 'conference-cms-common'
  ...
  <div class="content">
    <header>
      <div class="container save-button-container">
        <button class="save" :disabled="validations !== undefined" @click="updateTalkInfo(talk)">
          Save
        </button>
        <SpeakerInfo
          ...
          v-model:position="talk.speaker.position"
        />
      </div>
    </header>
    <main>
